"""
Supabase helper functions for user management
"""
import os
import uuid
...
print(f"🔧 Supabase Debug: URL: {supabase_url}")
print(f"🔧 Supabase Debug: Service Key: {supabase_service_key[:20] if supabase_service_key else 'None'}...")

if not supabase_url or not supabase_service_key:
    raise ValueError("Missing Supabase environment variables")

supabase: Client = create_client(supabase_url, supabase_service_key)
print(f"🔧 Supabase Debug: Client initialized successfully")
...
def list_users(query: str = "", page: int = 1, limit: int = 10, sort: str = "created_at", order: str = "desc", role_filter: str = "all", status_filter: str = "all") -> Dict[str, Any]:
    ...
    try:
        ...
        if query:
            ...
            # Note: Supabase OR conditions can be tricky, so we'll use a more comprehensive approach
